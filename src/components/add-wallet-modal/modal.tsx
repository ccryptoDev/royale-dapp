import { ModalContainer, ModalWrapper, ModalBorder, CrossIconContainer, ModalHeader, ModalBody, InputTitle, InputBox, StatusBox, WhitelistBox, StatusBtn, ButtonField, SaveButton } from "./style";
