    ...
    lotAmount: Yup.string()
      ...
      .test(
        ...
        (val) =>
          ...
          BigInt(
            toRoya((parseInt(val as string) * LotPrice.kingLot).toString())
          )
      ),
          ...
          <Form>
            ...
            <LotSelectContainer>
              ...
              <LotTextSecondary className="notranslate">
                {thousandSeparator(LotPrice.kingLot.toString())} ROYA
              </LotTextSecondary>
              <LotTextSecondary>=</LotTextSecondary>
              <LotTextSecondary className="notranslate">
                {thousandSeparator((LotPrice.kingLot * lotAmount).toString())}{" "}
                ROYA
              </LotTextSecondary>
            </LotSelectContainer>
